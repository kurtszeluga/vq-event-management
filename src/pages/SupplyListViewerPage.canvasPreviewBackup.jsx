// Backup of the pre-Safari-fix supply-list workflow.
// This route rendered the PDF into canvases with pdfjs and printed the page
// itself with window.print(). Keeping it in-repo makes rollback simple if the
// native-PDF viewer path needs to be reverted.
...
function SupplyListViewerPageCanvasPreviewBackup() {
...
export default SupplyListViewerPageCanvasPreviewBackup;
