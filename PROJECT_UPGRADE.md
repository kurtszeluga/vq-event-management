...
| Initiate Square refunds from the app | In Progress | Added the System Config toggle for app-initiated Square refunds. Default remains off so admins can record treasurer-processed Square refunds manually until the Square refund action is built. |
