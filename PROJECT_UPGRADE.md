...
| Item | Status | Notes |
| --- | --- | --- |
| Add compact mobile navigation | In Progress | The admin dashboard `Manage/Edit` row now collapses behind a single toggle below 760px (464px of stacked buttons down to 48px). Remaining and larger: the sticky `.site-header` nav itself still stacks up to six full-width links, consuming roughly 470px of an 812px phone viewport before any page content. |
